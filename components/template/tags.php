...
<section> 
  ...
  <div class="section_grid">    
    ...
    <article>
      <h3><code>&lt;abbr&gt;</code> abbreviation</h3>
      <p>The <abbr title="World Health Organization">WHO</abbr> was founded in 1948.</p>
    </article>  
  
    <article>
      <h3><code>&lt;cite&gt;</code> citation</h3>
      <p><cite>The Scream</cite> by Edward Munch. Painted in 1893.</p>
    </article> 

    <article>
      <h3><code>&lt;q&gt;</code> short quotation (quote)</h3>
    ...
    <article>
      <h3><code>&lt;s&gt;</code> strike-out</h3>
      <p><s>Only 50 tickets left!</s> - SOLD OUT!</p>
    </article> 
...
<hr>
    ...
    <article>
      <h3><code>&lt;nav&gt;</code> Anchor (a)</h3>
      <a href="https://www.example.com" title="This is a link" target="_blank">This is a link</a>
    </article>



    <article>
      <h3><code>&lt;button&gt;</code> <!-- button --></h3>
...
<article>
  <h3><code>&lt;hr&gt;</code> horizontal rule</h3>
  <hr>
</article>
    ...
    <p>Here are the HTML tags related to presenting code:</p>
    <ul>
      ...
      <li><code>&lt;var&gt;</code>: Defines a variable.</li>
      <li><code>&lt;tt&gt;</code>: Defines teletype text (deprecated in HTML5).</li>
    </ul>
    ...
    <article>
      <h3><code>&lt;samp&gt;</code> <!-- samp --></h3>
      <samp>Output: Hello, world!</samp>
    </article>

    <article>
      <h3><code>&lt;kbd&gt;</code> <!-- kbd --></h3>
      <kbd>Ctrl</kbd> + <kbd>C</kbd>
    </article>

    <article>
      <h3><code>&lt;var&gt;</code> <!-- var --></h3>
      <var>x</var> = <var>y</var> + 2;
    </article>
    
    <article>
      <h3><code>&lt;tt&gt;</code> (deprecated)</h3>
      <tt>Teletype text</tt>
    </article>
    
    <article>
      <h3><code>&lt;marquee&gt;</code> <!-- marquee --></h3>
    ...
    <p>Here are some HTML tags related to media:</p>
    <ul>
      <li><code>&lt;img&gt;</code>: Embeds an image.</li>
      <li><code>&lt;picture&gt;</code>: Contains zero or more <code>&lt;source&gt;</code> elements and one <code>&lt;img&gt;</code> element to provide multiple image formats.</li>
      <li><code>&lt;video&gt;</code>: Embeds a video.</li>
      <li><code>&lt;audio&gt;</code>: Embeds an audio file.</li>
      <li><code>&lt;iframe&gt;</code>: Embeds another HTML page.</li>
      <li><code>&lt;canvas&gt;</code>: Used to draw graphics via scripting (usually JavaScript).</li>
    </ul>
...
<section> 
    ...
    <article> 
      <h3><code>&lt;img&gt;</code> <!-- image--></h3>
      <img src="https://picsum.photos/1920" alt="Example Image">
    </article>

    <article> 
      <h3><code>&lt;picture&gt;</code> <!-- picture --></h3>
      <picture>
        <!--
    ...
    <article> 
      <h3><code>&lt;iframe&gt;</code> <!-- iframe--></h3>
      <iframe src="https://www.example.com" width="" height=""></iframe>
    </article>

    <article> 
      <h3><code>&lt;iframe&gt;</code> <!-- --> video </h3>
      <iframe width="" height="" src="https://www.youtube.com/embed/7X8II6J-6mU?si=CmMOSuUj7NTByHXR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </article>
   
    <article> 
      <h3><code>&lt;video&gt;</code> <!-- video --></h3>
      <video controls>
    ...
    <article> 
      <p>Example of <code>&lt;figure&gt;</code> & <code>&lt;figcaption&gt;</code>:</p>
      <figure>
        <img src="https://picsum.photos/1920" alt="Alt Tag">
...
<!-- 
        also add dynamic things, lie dropdoen, popover, anchor etc

    details + summary, popover and anchor
  -->
  ...
  <article>
    ...
    <article>
      ...
      <details>
        ...
        <details name="test">
          <summary name="test2">Subsection 1</summary>
          <p>Details for subsection 1.</p>
        </details>
        
        <details name="test">
          <summary name="test2">Subsection 2</summary>
          <p>Details for subsection 2.</p>
        </details>
        
        <details name="test">
          <summary name="test2">Subsection 3</summary>
    ...
    <article>
      <h3>Popover Example (no real html functionality... hmm)</h3>
      <div class="popover">
        Hover over me
    ...
    <article>
      <h3>Popover - The popover Attribute</h3>
      <p>Click the button and it will toggle between showing and hiding the popover element.</p>
  <!--
      obs - guess that defayukt layout is ecenterd, so the popover will be centered as well.
    -->
    ...
    <script>
      /*
      // Get the button and popover element
      const button = document.querySelector('button');
      const popover = document.querySelector('[popover]');
    
      // Add event listener to the button
      button.addEventListener('click', function() {
        // Toggle the hidden attribute on the popover element
      ...
      */
      ...
      <style>
        /* https://www.w3schools.com/cssref/tryit.php?filename=trycss_sel_popover-open */
        :popover-open {
          width: 150px;
          height: 150px;
          /*  position: absolute; */ 
