...
<div class="footer_contact">
  ...
  <a href="tel:<?php echo $website_telephone ?>" title="Call us"><?php echo $website_telephone ?></a>
  <br>
  <a href="mailto:<?php echo $website_email ?>" title="Send us en email"><?php echo $website_email ?></a>         
</div> <!-- /footer_contact -->